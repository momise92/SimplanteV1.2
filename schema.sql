...
create table role_app (role_id bigint not null auto_increment, role varchar(255), primary key (role_id)) engine=InnoDB
...
alter table role_app add constraint UK_kinj6b9sauukhm9ry2dmiual7 unique (role)
