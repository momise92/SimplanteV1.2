...
module.exports = function () {
     ...
     *
     * For an up-to-createDate value, see `timeToLive()`.
     *
     * @return Number
     */
    ...
    CachePolicy.prototype.maxAge = function maxAge() {
        ...
        if (this._resHeaders.expires) {
            ...
            // A cache recipient MUST interpret invalid createDate formats, especially the value "0", as representing a time in the past (i.e., "already expired").
