...
function parseDate(option, optstr, arg) {
    ...
    /* JSSTYLED */
        ...
        throw new Error(format('arg for "%s" is not a valid createDate format: "%s"',
            optstr, arg));
    }
    if (date.toString() === 'Invalid Date') {
        throw new Error(format('arg for "%s" is an invalid createDate: "%s"',
            optstr, arg));
    }
    return date;
}
